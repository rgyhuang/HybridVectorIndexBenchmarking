...
/// nb of neighbors for this level
    ...
    **************************************************************/
    ...
    /** Naive deletion: remove node and associated links in graph representation.
     * This is an O(N*M) operation.
     */
    void delete_node(storage_idx_t node_id);
};
